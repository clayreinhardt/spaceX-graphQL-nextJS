...
export default function Home({ rockets }) {
  ...
  return (
    <div >
      ...
      <main className=" bg-transparent flex flex-wrap my-4 gap-y-4 md:gap-x-4 min-h-screen space-y-0 py-5 items-center w-full justify-center flex-1 px-20 text-center ">
        {rockets.map((rocket) => {
          return (
