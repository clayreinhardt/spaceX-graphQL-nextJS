...
export default function Home({ launches }) {
  ...
  return (
    <div className=" w-screen min-h-screen">
      ...
      <main className=" flex flex-col space-y-5 py-5 items-center w-screen min-h-screen justify-center px-20 text-center" >
        ...
        <p className=" backdrop-filter backdrop-blur-sm backdrop-opacity-75 h-min rounded-3xl bg-transparent mt-3 h-min flex items-center justify-center flex-col lg:flex-row space-y-4 lg:space-y-0 lg:space-x-2 space-x-0 text-2xl">
          ...
          <div className=" w-full border-transparent border-red-400">
        <div className=" w-screen md:max-w-7xl md:mx-auto md:min-w-5xl flex-wrap justify-center items-center flex-shrink-0 flex ">
